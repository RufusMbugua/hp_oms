 ...
 */
$config['site_title']                 = "hp-lab.strathmore.edu";       // Site Title, example.com
$config['admin_email']                = "no-reply@hp-lab.strathmore.edu"; // Admin Email, admin@example.com
$config['default_group']              = 'user';           // Default group, use name
$config['admin_group']                = 'manager';             // Default administrators group, use name
...
/*
 ...
 | Default: auth/
 */
$config['email_templates'] = 'modules/users/views/auth_email_tpls/';
...
$config['message_start_delimiter'] = '<div class="alert alert-info">'; 	// Message start delimiter
